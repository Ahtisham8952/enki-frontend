...
export const MobileMenu = () => {
  ...
  return (
    <>
      ...
      >
        <Image src="https://cdn.enochdev.com/pluto-fund/menu-icon.svg" alt="menu" maxW={{lg: "auto", base: "45px"}} />
      </Button>
      <Drawer isOpen={isOpen} onClose={onClose}>
        ...
        <DrawerContent bg="linear-gradient(180deg, #070332 0%, #050038 100%)" h="100vh" overflow="hidden" minW="100%" position="relative" zIndex="99999">
          <Image src="https://cdn.enochdev.com/pluto-fund/menu-isolation.svg" alt="shape" maxW="50%" position="absolute" zIndex="1" bottom="0px" right="0px" />
